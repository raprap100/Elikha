            ...
            <div class="col-8 col-lg-9">
                ...
                <div class="p-3 pb-5 bg-white rounded">
                    ...
                    <div class="row grid text-center">
                        ...
                        <div class="col-sm-6 p-2"><h4 style="font-family:Helvetica Neue">Profile Views</h4> <br>
                        ...
                        <div class="col-sm-6 p-2"><h4 style="font-family:Helvetica Neue">Status</h4>
                            @if($userVerification)
                            ...
                            @else
                            <a href="{{ route('artistVerify') }}" style="color: black;">
