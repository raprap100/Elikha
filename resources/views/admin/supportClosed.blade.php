            ...
            <div class="col-mb-8">
                <div class="card shadow mb-8 h-100 p-3 w-100">
                    <div class="row no-gutters align-items-center">
                        ...
                        <a href="support" type="button" class="btn btn-light" style="margin-right: 20px">Open</button>
                        <a href="supportClosed" type="button" class="btn btn-primary">Closed</a>
                        </div>
                        </div>
                        <div class="card-body">
                            <table>
                              ...
                              {{ $closedTicket->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
