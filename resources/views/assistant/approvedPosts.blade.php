            ...
            <div class="col-mb-8">
                <div class="card shadow mb-8 h-100 p-3 w-100">
                    <div class="row no-gutters align-items-center">
                        ...
                        <a href="assistposts" type="button" class="btn btn-light" style="margin-right: 20px">Pending</a>
                        <a href="assistapprovePost" type="button" class="btn btn-primary">Approved</a>
                        </div>
                        </div>
                        <div class="card-body">
                            <table>
