<?php $page = 'accountsetting';?> @include ('inc.navassistant')
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="mb-0" style="font-family:Helvetica Neue">Account Setting</h1>
            ...
            <div class="col-mb-8">
                <div class="card shadow mb-8 h-100 p-3 w-100">
                    <div class="row no-gutters align-items-center">
                        <h2 class="mb-1" style="color: #535353; font-family:Helvetica Neue">Change Password</h2>
                        

                    <form action="{{ route('assistaccountsetting') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            @if (session('status'))
