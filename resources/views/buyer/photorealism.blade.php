    ...
    <div class="col">
      ...
      <div class="row d-flex">
        <div class="d-flex align-items-center justify-content-between mb-4">
          <div class="col-md-6">
          <form class="d-flex" role="search" action="{{ route('photorealism') }}" method="GET">
        ...
        <div class="col-md-6">
          ...
          <div class="dropdown">
              ...
              <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="{{ route('photorealism', ['sort_type' => 'for_sale', 'search' => request('search')]) }}">For Sale</a></li>
                  <li><a class="dropdown-item" href="{{ route('photorealism', ['sort_type' => 'for_auction', 'search' => request('search')]) }}">For Auction</a></li>
              </ul>
          </div>
        </div>
      </div>
